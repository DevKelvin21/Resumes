...
#oneline-title-item(
  title: "Backend & APIs",
  content: [Python, FastAPI, RESTful APIs, Microservices, SQL (also familiar with: .NET Core, Node.js)]
)
#oneline-title-item(
  title: "Frontend",
...
#oneline-title-item(
  title: "Databases",
  content: [PostgreSQL, MySQL, MongoDB, Firestore (also familiar with: SQL Server)]
)
#oneline-title-item(
  title: "Testing & Quality",
  content: [TDD, Pytest, Jest, React Testing Library, Cypress, Automated Testing]
)
