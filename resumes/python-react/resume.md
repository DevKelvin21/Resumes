...
El Salvador
linkedin.com/in/kelvin-rojas-chilin | kelvin.rojas.sv@gmail.com | +503 7110 - 1345

---

## About Me

Senior Full-Stack Engineer with 4+ years of experience architecting and delivering scalable, cloud-native applications using Python, React, and modern cloud platforms. Proven expertise in designing distributed systems, implementing microservices architectures, and optimizing CI/CD pipelines. Strong advocate for SOLID principles, Clean Code, ORM best practices, and test-driven development. Experienced in mentoring junior developers and driving technical decisions that improve system performance, reduce infrastructure costs, and enhance team productivity. Advanced English proficiency for technical collaboration.

---

## Experience

### Software Engineer | NiCE Ltd | Remote
**Jan 2025 - Present**
...
- Optimized MySQL database schemas and complex queries using **ORM best practices** (including patterns applicable to SQLAlchemy and other Python ORMs), improving data retrieval performance by 20% for 3,000+ daily users.
...
### Software Developer | Clearview LLC | Remote
**Jun 2023 - Dec 2024**

- Architected and built RESTful APIs following clean architecture principles, implementing dependency injection, repository pattern, and ORM for data access, resulting in 10% improvement in system uptime.
...
- Conducted code reviews focusing on SOLID principles, clean code standards, and architectural improvements, mentoring team members on modern development best practices.

### FullStack Engineer | Appointments Today LLC | Remote
**Nov 2022 - May 2023**

- **Designed and implemented microservices architecture on GCP using Python/FastAPI**, implementing event-driven patterns with Pub/Sub that reduced infrastructure costs by 25% while improving scalability for distributed systems.
...
### Web Developer | IBG America LLC | Santa Ana, El Salvador
**Jun 2022 - Oct 2022**
...
### UI Designer and Frontend Developer | Freelance | Remote
**Nov 2020 - May 2022**
...
**Backend & APIs:** Python, FastAPI, RESTful APIs, Microservices, SQL (also familiar with: .NET Core, Node.js)

**Frontend:** React, TypeScript, Angular, Redux, Next.js, Material UI, Tailwind CSS

**Cloud & DevOps:** GCP, AWS, CI/CD (GitHub Actions), Docker, Kubernetes

**Architecture & Patterns:** Distributed Systems, Event-Driven Architecture, Cloud-Native Design, SOLID Principles, Clean Code

**Databases:** PostgreSQL, MySQL, MongoDB, Firestore (also familiar with: SQL Server)

**Testing & Quality:** TDD, Pytest, Jest, React Testing Library, Cypress, Automated Testing
...
**Spanish:** Native
**English:** Advanced (Technical and conversational proficiency)
